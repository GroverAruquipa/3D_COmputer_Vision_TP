function [resultImg] = imageRect(originalImg, rectWidth, rectHeight)
    %% Initialize parameter
    % rectidth=width of the original image
    % rectHeight=height of the original image
    ...
    %% Mouse input
    xlabel ('Select the 4 points to define the are for rectification');
    [ x, y ] = ginput(4);
