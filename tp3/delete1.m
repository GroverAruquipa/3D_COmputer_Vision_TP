...
% Paramètres caméra
   ...
   % K1=K; K2=K;
   Kpx = [  1.0000e+03   0.0000e+00   1.2800e+02
           0.0000e+00   1.0000e+03   2.3400e+02
           0.0000e+00   0.0000e+00   1.0000e+00];
   %Inctrinsic matrix of the camera
    K = [  1.15422732e+03   0.00000000e+00   6.71627794e+02;
           0.00000000e+00   1.14818221e+03   3.86046312e+02;
           0.00000000e+00   0.00000000e+00   1.00000000e+00];
       
      K = [  3158   0.00000000e+00   1986;
           0.00000000e+00   3165   1440;
           0.00000000e+00   0.00000000e+00   1.00000000e+00];  
...
% Create vecotor with the points 3D different gama
    ...
    for i=1:length(gama)
        ...
        axis('ij');
        for i=1:size(pts3D)
            plot3(pts3D(i,1), pts3D(i,2), pts3D(i,3),'m+');6
            hold on
            %axis equal
...
%% Cycle to connect the points with lines 
    ...
    %plotCamera('Location', T1_w(1:3,4)', 'Orientation', T1_w(1:3,1:3), 'Opacity', 0, 'Size', 0.1);   
    %hold on
    %plotCamera('Location', T2_w(1:3,4)', 'Orientation', T2_w(1:3,1:3), 'Opacity', 0, 'Size', 0.1);   
    %hold on
    %plotCamera('Location', T1_w(1:3,4)', 'Orientation', T1_w(1:3,1:3), 'Opacity', 0, 'Size', 0.1);   
    %hold on
    %plotCamera('Location', T2_w(1:3,4)', 'Orientation', T2_w(1:3,1:3), 'Opacity', 0, 'Size', 0.1);   
